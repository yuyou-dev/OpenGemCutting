...
const HELP_SECTIONS = [
  {
    ...
    steps: [
      ["01", "打开或创建项目", "首次打开会准备两份可编辑的琢型项目。点击卡片继续，或用左侧“＋新建项目”选择默认起点、预设底胚或上传 OBJ。右侧从右向左显示最近三个项目，“全部”展开其余作品；搜索会显示全部匹配项。四种预设高度为最大横向尺寸的 100%，A 形保留贯穿孔；预设从零切割开始。卡片左上角的删除入口会经确认后从此浏览器移除项目，不可撤销，重要设计请先导出 JSON。已有本地备份会迁入项目列表，原备份仍保留。"],
