...
const HELP_SECTIONS = [
  {
    ...
    steps: [
      ["01", "找到接近想法的切型", "文件 → 浏览预设琢型，用外形、有效面数和 L/W 长宽比缩小范围，也可组合名称、作者或来源关键词。逐页比较四视图，再载入一个起点；先导出 JSON 留住基准版。"],
  ...
  },
  {
    ...
    facts: [
      ["返回项目与反馈", "品牌附近的“GitHub 仓库”始终保留；普通编辑、收起侧栏和光学仿真时均可使用。点击在新标签页打开 OpenGemCutting 仓库，当前设计留在原页面。"],
    ],
    keys: [
