...
import { FormatCenterPage } from "./components/FormatCenterPage.jsx";
...
export function App() {
  ...
  // The format center reads the committed project and opens results as new projects.
  const openFormats = (intent = null) => {
    setFormatIntent(intent);
    navigate("formats");
  };
