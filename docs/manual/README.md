...
3. 从台面、亭部、正视、侧视继续拖动。光学可翻过顶部和底部；编辑在上下观察边界停止，反向拖动应平滑离开。精确轴向的水平拖动会绕观察轴转动，不是横向平移。
...
1.1.1 更新旋转规则与 PDF 页脚；未改变布局的示意截图沿用已核对的 1.1.0 界面，图片中的旧版本标识仅表示采集基线，操作规则以当前正文为准。
