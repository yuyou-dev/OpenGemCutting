...
2. Read `AGENTS.md`, `docs/architecture/design-system.md`, and `docs/architecture/state-contract.md` when the change touches product behavior, UI, geometry, or CUT interactions.
