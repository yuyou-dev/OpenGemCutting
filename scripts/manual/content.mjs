...
export const manualPages = [
  ...
  },
  {
    ...
    toc: [
      ["建立自己的起点", "03–05", "练习文件、预设选择、界面地图"],
      ["把造型比例调顺", "06–08", "明确编辑入口、角度与深度、整体变换"],
      ["让刻面在想要的位置会合", "09–13", "Jump、单点、棱比例对比、双 Meet"],
      ["让节奏服务构图", "14–15", "自定义主面、重复与镜像、预形用途"],
      ["改过上游以后继续设计", "16–17", "来源修复、逐层试切"],
      ["比较材质与亮暗关系", "18–19", "光学观察、视角与比较方法"],
      ["把方案交给下一位设计伙伴", "20–22", "文件、恢复、快捷操作、交付说明"],
    ],
  },
  {
    title: "先选一个能说明问题的起点",
  ...
  },
  {
    ...
    kicker: "起步 · 选型",
    intro:
      "如果已有水滴、椭圆或其他外形目标，从预设库找接近的轮廓通常更直接。把预设当成研究起点，保留作者与来源，另存自己的变体。",
    image: "02-preset-library",
    caption: "真实预设库：四视图一起看，避免透视造成的比例误判。",
    steps: [
      ["打开候选", "文件 → 浏览预设琢型。按外形、名称或作者寻找起点。"],
      [
        "看四个方向",
      ...
      [
        "载入并命名",
        "确认后载入，修改顶部切型名称；先导出一份 JSON 作为原始方案。",
      ],
    ],
    question:
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        "顶部与画布：看清并管理方案",
        "顶部切换视角、显示模式、文件和撤销。拖动画布旋转，滚轮缩放，Shift + 拖拽平移。",
      ],
    ],
  },
  {
  ...
  {
    title: "意外关闭后，先找回已提交的设计",
    kicker: "恢复 · 帮助 · 快捷操作",
    intro:
      "本地备份可以找回最近已提交的文档与材质，但不能替代你主动保存的 JSON。使用不同站点地址或浏览器，可能看不到同一份备份。",
    image: "round-recovery",
    caption: "根据名称、更新时间和层数选择恢复；不同标签页各自保存独立副本。",
    blocks: [
      [
        "恢复范围",
